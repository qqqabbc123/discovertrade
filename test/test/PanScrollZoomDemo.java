...
public class PanScrollZoomDemo extends JFrame
    ...
    private JFreeChart createChart() {
        ...
        xyPlot.mapDatasetToRangeAxis(1, new Integer(0));
        xyPlot.mapDatasetToDomainAxis(1, new Integer(1));
    ...
    public void mouseDragged(MouseEvent event) {
        try {
            if (this.panStartPoint != null) {
                ...
                if (plot instanceof XYPlot) {
                    XYPlot xyPlot = (XYPlot) plot;
                    ValueAxis yAxis = xyPlot.getRangeAxis(1);
    ...
    private void zoomVertical(double y, double zoomFactor) {
        ...
        if (chart.getPlot() instanceof XYPlot) {
            ...
            if (chart.getPlot() instanceof XYPlot) {
                ...
                ValueAxis secYAxis = xyp.getRangeAxis(1);
                if (secYAxis != null) {
                    double anchorValue =
